...
public class MatchHistoryService {
  private final AccountMatchesStorePort accountMatchesStorePort;
  ...
  private void processData(AccountMatchesDTO matches) {
    accountMatchesStorePort
        .findByPuuid(matches.getAccountDTO().getPuuid())
  ...
  private AccountMatchesMO processNewMatches(
    ...
    return accountMatchesStorePort.save(existing);
  }
  ...
  private AccountMatchesMO createNew(AccountMatchesDTO matches) {
    ...
    return accountMatchesStorePort.save(entity);
  }

  public Mono<Boolean> matchExists(String puuid, String matchId) {
    return Mono.fromCallable(() -> accountMatchesStorePort.findByPuuid(puuid))
        .map(
